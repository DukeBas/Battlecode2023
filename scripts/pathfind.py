...
# This generator script is originally from jmerle @ Github
# https://github.com/jmerle/battlecode-2022/tree/master/scripts
# Licensed under MIT license
# Code below is modified from the original!
...
// Code generated by scripts/pathfind.py
public class Pathfind{vision_radius} implements Pathfinding {{
    ...
    public Pathfind{vision_radius}(RobotController rc) {{
        Pathfind{vision_radius}.rc = rc;
...
def main():
    for vision_radius in [20, 34, 53]: #TODO change to appropriate ranges
        generate_pathfinding(vision_radius)
