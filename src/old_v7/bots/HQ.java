...
import old_v7.util.Constants;
import old_v7.util.Map_helper;
import old_v7.util.PseudoDFS20;
...
//    int mostBytecodeExtracted = -1;
    ...
    void init_HQ() throws GameActionException {
    ...
    void get_enemy_hq_locs() throws GameActionException {
        if (HQ_id == 0) {
    ...
    void check_symmetry() throws GameActionException {
